-- Day2_a
--declare @input varchar(2000) = '179	2358	5197	867	163	4418	3135	5049	187	166	4682	5080	5541	172	4294	1397
...
CREATE OR ALTER FUNCTION [dbo].[AdventChecksum] ( @input VARCHAR(1000))
RETURNS TABLE
AS RETURN
